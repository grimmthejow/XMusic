...
public class FastScroller {
    ...
    public FastScroller(@NonNull ViewGroup view, @NonNull ViewHelper viewHelper,
        ...
        mNavigationBarHeight = XUtils.getNavigationBarHeight(context);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mDragging) {
                    ...
                    scrollToThumbOffset2(thumbOffset);
                }
                break;
    ...
    private void scrollToThumbOffset2(int thumbOffset) {
        int thumbOffsetRange = getDragThumbRange();
        thumbOffset = MathUtils.clamp(thumbOffset, 0, thumbOffsetRange);
        int scrollOffset = (int) ((long) getScrollOffsetRange2() * thumbOffset / thumbOffsetRange);
        mViewHelper.scrollTo(scrollOffset);
    }
    ...
    private int getScrollOffsetRange2() {
        return mViewHelper.getScrollRange() - mView.getHeight() + mNavigationBarHeight*10;
    }
